...
def read_quiz_by_id_route(current_quiz: Annotated[Quiz, Depends(get_current_quiz)], session: Annotated[Session, Depends(get_session)]) -> QuizRead:
    return read_quiz_by_id(current_quiz, session)
